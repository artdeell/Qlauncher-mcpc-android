...
public final class SpriteShootoutMapped {
    ...
    private abstract class SpriteRenderer {
        ...
        final /* synthetic */ SpriteShootoutMapped this$0;
        protected int vshID;

        private SpriteRenderer(SpriteShootoutMapped spriteShootoutMapped) {
            this.this$0 = spriteShootoutMapped;
        }

        /* synthetic */ SpriteRenderer(SpriteShootoutMapped spriteShootoutMapped, C08381 r7) {
            C08381 r2 = r7;
            this(spriteShootoutMapped);
        }
    ...
    private abstract class SpriteRendererBatched extends SpriteRenderer {
        ...
        SpriteRendererBatched(SpriteShootoutMapped spriteShootoutMapped) {
            RuntimeException runtimeException;
            SpriteShootoutMapped spriteShootoutMapped2 = spriteShootoutMapped;
            this.this$0 = spriteShootoutMapped2;
            super(spriteShootoutMapped2, null);
        ...
        /* access modifiers changed from: protected */
        public void animate(Sprite sprite, SpriteRender spriteRender, int i, int i2, int i3, int i4) {
            int i5 = i2;
            int i6 = i4;
            ...
            int i9 = i5 + i3;
            while (i7 < i9) {
                float f4 = spriteArr[i7].f227dx;
                float f5 = spriteArr[i7].f229x + (f4 * ((float) i6));
                if (f5 < f) {
                    f5 = f;
                    f4 = -f4;
                } else if (f5 > f2) {
                ...
                spriteArr[i7].f227dx = f4;
                spriteArr[i7].f229x = f5;
                spriteRenderArr[i8].f231x = f5;
                float f6 = spriteArr[i7].f228dy;
                float f7 = spriteArr[i7].f230y + (f6 * ((float) i6));
                if (f7 < f) {
                    f7 = f;
                    f6 = -f6;
                } else if (f7 > f3) {
                ...
                spriteArr[i7].f228dy = f6;
                spriteArr[i7].f230y = f7;
                spriteRenderArr[i8].f232y = f7;
                i7++;
                i8++;
            }
        }
        ...
        public void updateBalls(int i) {
            ...
            Sprite sprite = (Sprite) Sprite.malloc(i2);
            if (this.sprites != null) {
                this.sprites.view = 0;
                this.sprites.copyRange(sprite, Math.min(i2, this.spriteCount));
            }
            if (i2 > this.spriteCount) {
                for (int i3 = this.spriteCount; i3 < i2; i3++) {
                    sprite.view = i3;
                    sprite.f229x = (float) ((int) ((random4.nextFloat() * ((float) (800 - this.this$0.ballSize))) + (0.5f * ((float) this.this$0.ballSize))));
                    sprite.f230y = (float) ((int) ((random4.nextFloat() * ((float) (600 - this.this$0.ballSize))) + (0.5f * ((float) this.this$0.ballSize))));
                    sprite.f227dx = (0.4f * random4.nextFloat()) - 0.2f;
                    sprite.f228dy = (0.4f * random4.nextFloat()) - 0.2f;
                }
            }
            this.sprites = sprite;
            this.spriteCount = i2;
    ...
    private class SpriteRendererMapped extends SpriteRendererBatched {
        ...
        SpriteRendererMapped(SpriteShootoutMapped spriteShootoutMapped) {
            SpriteShootoutMapped spriteShootoutMapped2 = spriteShootoutMapped;
            this.this$0 = spriteShootoutMapped2;
            super(spriteShootoutMapped2);
        ...
        public void render(boolean z, boolean z2, int i) {
            ...
            while (i3 < this.this$0.ballCount) {
                if (z4) {
                    ...
                    animate(this.sprites, (SpriteRender) SpriteRender.map(map), this.this$0.ballSize, i3, min, i2);
    ...
    private class SpriteRendererPlain extends SpriteRendererBatched {
        ...
        SpriteRendererPlain(SpriteShootoutMapped spriteShootoutMapped) {
            SpriteShootoutMapped spriteShootoutMapped2 = spriteShootoutMapped;
            this.this$0 = spriteShootoutMapped2;
            super(spriteShootoutMapped2);
            System.out.println("Shootout Implementation: CPU animation & BufferData");
            this.spritesRender = (SpriteRender) SpriteRender.malloc(IDirectInputDevice.DI_FFNOMINALMAX);
        }

        private void animate(int i, int i2, int i3) {
            animate(this.sprites, this.spritesRender, this.this$0.ballSize, i, i2, i3);
            GL15.glBufferData(34962, 80000, 35040);
            GL15.glBufferSubData(34962, 0, this.spritesRender.backingByteBuffer());
        }
        ...
        public void render(boolean z, boolean z2, int i) {
            ...
            int i4 = 0;
            while (i3 < this.this$0.ballCount) {
                GL15.glBindBuffer(34962, this.animVBO[i4]);
                if (z4) {
                    animate(i3, min, i2);
                }
                if (z3) {
    ...
    private class SpriteRendererTF extends SpriteRenderer {
        ...
        SpriteRendererTF(SpriteShootoutMapped spriteShootoutMapped) {
            RuntimeException runtimeException;
            RuntimeException runtimeException2;
            ...
            GL20.glUniform1f(this.ballSizeLoc, 0.5f * ((float) spriteShootoutMapped2.ballSize));
            this.vshID = GL20.glCreateShader(35633);
            GL20.glShaderSource(this.vshID, (CharSequence) "void main(void) {\n     gl_Position = gl_ModelViewProjectionMatrix * gl_Vertex;\n}");
            GL20.glCompileShader(this.vshID);
            if (GL20.glGetShaderi(this.vshID, 35713) == 0) {
        ...
        public void updateBalls(int i) {
            int i2 = i;
            if (this.tfVBO[0] != 0) {
                GL15.glGetBufferSubData(35982, 0, this.sprites.backingByteBuffer());
            }
            doUpdateBalls(i2);
            if (this.tfVBO[0] != 0) {
    ...
    public static void main(String[] strArr) {
        SpriteShootoutMapped spriteShootoutMapped;
        ...
        if (!MappedObjectClassLoader.fork(SpriteShootoutMapped.class, strArr2)) {
            try {
                SpriteShootoutMapped spriteShootoutMapped2 = spriteShootoutMapped;
                SpriteShootoutMapped spriteShootoutMapped3 = new SpriteShootoutMapped();
                spriteShootoutMapped2.start();
    ...
    private static ByteBuffer readImage(BufferedImage bufferedImage) throws IOException {
        ...
        if (numBands == 4) {
            ...
            while (i3 < i) {
                ...
                pixel4b.view = i3;
                pixel4b.f226r = packUByte01(unpackUByte01 * unpackUByte01(bArr[i2 + 2]));
                pixel4b.f225g = packUByte01(unpackUByte01 * unpackUByte01(bArr[i2 + 1]));
                pixel4b.f224b = packUByte01(unpackUByte01 * unpackUByte01(bArr[i2 + 0]));
                pixel4b.f223a = bArr[i2 + 3];
                i3++;
                i2 += 4;
            }
            ...
            while (i5 < i) {
                pixel3b.view = i5;
                pixel3b.f222r = bArr[i4 + 2];
                pixel3b.f221g = bArr[i4 + 1];
                pixel3b.f220b = bArr[i4 + 0];
                i5++;
                i4 += 3;
            }
            ...
            ByteBuffer put = createByteBuffer.put(bArr, 0, createByteBuffer.capacity());
    ...
    private void run() {
        ...
        while (this.run) {
            ...
            if (currentTimeMillis > System.currentTimeMillis()) {
                ...
                printStream2.println(sb5.append("Animation: ").append(this.animateTime / j).toString());
                this.animateTime = 0;
                j = 0;
            }
        }
