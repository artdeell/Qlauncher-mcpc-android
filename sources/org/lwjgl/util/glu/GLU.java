...
public class GLU {
    ...
    /* renamed from: PI */
    static final float f238PI = 3.1415927f;
    ...
    public static int gluBuild2DMipmaps(int i, int i2, int i3, int i4, int i5, int i6, ByteBuffer byteBuffer) {
        return MipMap.gluBuild2DMipmaps(i, i2, i3, i4, i5, i6, byteBuffer);
    }
    ...
    public static String gluErrorString(int i) {
        ...
        switch (i2) {
            ...
            default:
                return Util.translateGLErrorString(i2);
        }
    }
    ...
    public static void gluLookAt(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9) {
        Project.gluLookAt(f, f2, f3, f4, f5, f6, f7, f8, f9);
    }
    ...
    public static void gluOrtho2D(float f, float f2, float f3, float f4) {
        GL11.glOrtho((double) f, (double) f2, (double) f3, (double) f4, -1.0d, 1.0d);
    }
    ...
    public static void gluPickMatrix(float f, float f2, float f3, float f4, IntBuffer intBuffer) {
        Project.gluPickMatrix(f, f2, f3, f4, intBuffer);
    }
    ...
    public static int gluScaleImage(int i, int i2, int i3, int i4, ByteBuffer byteBuffer, int i5, int i6, int i7, ByteBuffer byteBuffer2) {
        return MipMap.gluScaleImage(i, i2, i3, i4, byteBuffer, i5, i6, i7, byteBuffer2);
    }
    ...
    public static boolean gluUnProject(float f, float f2, float f3, FloatBuffer floatBuffer, FloatBuffer floatBuffer2, IntBuffer intBuffer, FloatBuffer floatBuffer3) {
        return Project.gluUnProject(f, f2, f3, floatBuffer, floatBuffer2, intBuffer, floatBuffer3);
    }
}
