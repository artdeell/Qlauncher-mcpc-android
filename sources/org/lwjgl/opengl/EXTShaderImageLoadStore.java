...
public final class EXTShaderImageLoadStore {
    ...
    public static void glBindImageTextureEXT(int i, int i2, int i3, boolean z, int i4, int i5, int i6) {
        int i7 = i;
        int i8 = i2;
        int i9 = i3;
        boolean z2 = z;
        ...
        int i11 = i5;
        int i12 = i6;
        long j = GLContext.getCapabilities().glBindImageTextureEXT;
        BufferChecks.checkFunctionAddress(j);
        nglBindImageTextureEXT(i7, i8, i9, z2, i10, i11, i12, j);
    }

    public static void glMemoryBarrierEXT(int i) {
        int i2 = i;
        long j = GLContext.getCapabilities().glMemoryBarrierEXT;
        BufferChecks.checkFunctionAddress(j);
        nglMemoryBarrierEXT(i2, j);
    }
