...
class BaseAdView extends ViewGroup {
    ...
    public BaseAdView(Context context, int i) {
        ...
        super(context);
        zzab zzab2 = zzab;
        zzab zzab3 = new zzab(this, zze(i2));
        this.zzoJ = zzab2;
    }
    ...
    public BaseAdView(Context context, AttributeSet attributeSet, int i) {
        ...
        zzab zzab2 = zzab;
        zzab zzab3 = new zzab(this, attributeSet2, false, zze(i2));
        this.zzoJ = zzab2;
    }
    ...
    public BaseAdView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        zzab zzab2 = zzab;
        zzab zzab3 = new zzab(this, attributeSet2, false, zze(i3));
        this.zzoJ = zzab2;
    }
    ...
    public void setInAppPurchaseListener(InAppPurchaseListener inAppPurchaseListener) {
        ...
        this.zzoJ.setInAppPurchaseListener(inAppPurchaseListener2);
    }

    public void setPlayStorePurchaseParams(PlayStorePurchaseListener playStorePurchaseListener, String str) {
        PlayStorePurchaseListener playStorePurchaseListener2 = playStorePurchaseListener;
        String str2 = str;
        this.zzoJ.setPlayStorePurchaseParams(playStorePurchaseListener2, str2);
    }
}
