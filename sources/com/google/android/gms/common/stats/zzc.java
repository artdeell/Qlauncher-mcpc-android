...
public final class zzc {
    ...
    public static final class zza {
        public static zzlz<String> zzanA = zzlz.zzv("gms:common:stats:connections:ignored_calling_processes", LibrariesRepository.MOJANG_MAVEN_REPO);
        public static zzlz<String> zzanB = zzlz.zzv("gms:common:stats:connections:ignored_calling_services", LibrariesRepository.MOJANG_MAVEN_REPO);
        public static zzlz<String> zzanC = zzlz.zzv("gms:common:stats:connections:ignored_target_processes", LibrariesRepository.MOJANG_MAVEN_REPO);
