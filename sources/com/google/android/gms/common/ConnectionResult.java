...
public final class ConnectionResult implements SafeParcelable {
    ...
    static {
        ...
        ConnectionResult connectionResult3 = new ConnectionResult(0);
        zzafB = connectionResult2;
        zzb zzb2 = zzb;
        zzb zzb3 = new zzb();
        CREATOR = zzb2;
    }
    ...
    static String getStatusString(int i) {
        ...
        switch (i2) {
            ...
            default:
                ...
                return sb2.append("UNKNOWN_ERROR_CODE(").append(i2).append(")").toString();
        }
    }
    ...
    public boolean equals(Object obj) {
        Object obj2 = obj;
        if (obj2 != this) {
            if (!(obj2 instanceof ConnectionResult)) {
                return false;
            }
