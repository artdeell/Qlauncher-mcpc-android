...
class zzd {
    ...
    static abstract class zza {
        ...
        protected zza(byte[] bArr) {
            byte[] bArr2 = bArr;
            zzx.zzb(bArr2.length == 25, (Object) "cert hash data has incorrect length");
            this.zzafG = Arrays.hashCode(bArr2);
        }
        ...
        protected static byte[] zzcs(String str) {
            ...
            try {
                ...
                AssertionError assertionError3 = new AssertionError(unsupportedEncodingException);
        ...
        public boolean equals(Object obj) {
            ...
            return Arrays.equals(getBytes(), ((zza) obj2).getBytes());
        }
    ...
    static class zzb extends zza {
        ...
        zzb(byte[] bArr) {
            byte[] bArr2 = bArr;
            super(Arrays.copyOfRange(bArr2, 0, 25));
            this.zzafH = bArr2;
        }
    ...
    static abstract class zzc extends zza {
        ...
        static {
            ...
            WeakReference<byte[]> weakReference2 = weakReference;
            WeakReference<byte[]> weakReference3 = new WeakReference<>(null);
            zzafJ = weakReference2;
        }
            ...
            synchronized (this) {
                try {
                    ...
                    if (bArr == null) {
                        bArr = zzoL();
                        WeakReference<byte[]> weakReference2 = weakReference;
                        WeakReference<byte[]> weakReference3 = new WeakReference<>(bArr);
                        this.zzafI = weakReference2;
                    }
                } catch (Throwable th) {
                    Throwable th2 = th;
                    throw th2;
    ...
    static final class C0887zzd {
        static final zza[] zzafK;

        static {
            C02511 r6;
            C02522 r62;
            zza[] zzaArr = new zza[2];
            zza[] zzaArr2 = zzaArr;
            C02511 r3 = r6;
            C02511 r4 = new zzc(zza.zzcs("0\u0004C0\u0003+ \u0003\u0002\u0001\u0002\u0002\t\u0000ÂàFdJ00")) {
                /* access modifiers changed from: protected */
                public byte[] zzoL() {
            ...
            zza[] zzaArr3 = zzaArr;
            C02522 r32 = r62;
            C02522 r42 = new zzc(zza.zzcs("0\u0004¨0\u0003 \u0003\u0002\u0001\u0002\u0002\t\u0000Õ¸l}ÓNõ0")) {
                /* access modifiers changed from: protected */
                public byte[] zzoL() {
