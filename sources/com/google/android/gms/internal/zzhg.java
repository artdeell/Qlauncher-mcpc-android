...
public final class zzhg {
    ...
    private int zzJB = 0;
    private String zzJC = LibrariesRepository.MOJANG_MAVEN_REPO;
    ...
    private void zzD(Map<String, List<String>> map) {
        ...
        if (this.zzJF == null) {
            this.zzJF = zzf(map2, "X-Afma-Reward-Video-Start-Urls");
        }
    }
    ...
    private void zzE(Map<String, List<String>> map) {
        Map<String, List<String>> map2 = map;
        if (this.zzJG == null) {
            this.zzJG = zzf(map2, "X-Afma-Reward-Video-Complete-Urls");
        }
    }

    private void zzF(Map<String, List<String>> map) {
        this.zzJH = this.zzJH | zzg(map, "X-Afma-Use-Displayed-Impression");
    }
    ...
    static long zze(Map<String, List<String>> map, String str) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            try {
                return (long) (Float.parseFloat(str3) * 1000.0f);
            } catch (NumberFormatException e) {
                NumberFormatException numberFormatException = e;
                StringBuilder sb2 = sb;
                StringBuilder sb3 = new StringBuilder();
                zzin.zzaK(sb2.append("Could not parse float from ").append(str2).append(" header: ").append(str3).toString());
            }
        }
        return -1;
    }
    ...
    private void zzr(Map<String, List<String>> map) {
        this.zzJx = this.zzJx | zzg(map, "X-Afma-Custom-Rendering-Allowed");
    }

    private void zzs(Map<String, List<String>> map) {
        this.zzJu = this.zzJu | zzg(map, "X-Afma-Mediation");
    }
    ...
    public AdResponseParcel zzj(long j) {
        ...
        AdResponseParcel adResponseParcel3 = new AdResponseParcel(this.zzCu, this.zzJo, this.zzxY, this.zzJp, this.zzJs, this.zzJt, this.zzJu, -1, this.zzGK, this.zzJw, this.mOrientation, this.zzJn, j, this.zzJq, this.zzJr, this.zzJx, this.zzJy, this.zzJz, this.zzJA, false, this.zzJB, this.zzJC, this.zzJD, this.zzuS, this.zzJE, this.zzJF, this.zzJG, this.zzJH);
