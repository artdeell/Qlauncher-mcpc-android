...
public final class zzbt {
    ...
    public static final zzbp<Integer> zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) IDirectInputDevice.DI_FFNOMINALMAX);
    public static final zzbp<Boolean> zzvU = zzbp.zza(0, "gads:video:metric_reporting_enabled", Boolean.valueOf(false));
    public static final zzbp<String> zzvV = zzbp.zza(0, "gads:video:metric_frame_hash_times", LibrariesRepository.MOJANG_MAVEN_REPO);
    ...
    public static void initialize(Context context) {
        ...
        C02791 r2 = new Callable<Void>() {
            /* renamed from: zzdt */
            public Void call() {
                zzr.zzbL().initialize(context2);
                return null;
            }
        };
        Object zzb = zzjb.zzb(r1);
    }
