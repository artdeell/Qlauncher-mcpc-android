...
class ActivityCompat21 {
    ...
    private static SharedElementCallback createCallback(SharedElementCallback21 sharedElementCallback21) {
        SharedElementCallbackImpl sharedElementCallbackImpl;
        SharedElementCallback21 sharedElementCallback212 = sharedElementCallback21;
        SharedElementCallbackImpl sharedElementCallbackImpl2 = null;
        if (sharedElementCallback212 != null) {
            SharedElementCallbackImpl sharedElementCallbackImpl3 = sharedElementCallbackImpl;
            SharedElementCallbackImpl sharedElementCallbackImpl4 = new SharedElementCallbackImpl(sharedElementCallback212);
            sharedElementCallbackImpl2 = sharedElementCallbackImpl3;
        }
        return sharedElementCallbackImpl2;
    }
