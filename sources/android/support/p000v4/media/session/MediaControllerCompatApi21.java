...
class MediaControllerCompatApi21 {
    ...
    static class CallbackProxy<T extends Callback> extends android.media.session.MediaController.Callback {
        ...
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            ...
            this.mCallback.onMetadataChanged(mediaMetadata2);
        }

        public void onPlaybackStateChanged(PlaybackState playbackState) {
            PlaybackState playbackState2 = playbackState;
            this.mCallback.onPlaybackStateChanged(playbackState2);
        }
        ...
        public void onSessionEvent(String str, Bundle bundle) {
            ...
            this.mCallback.onSessionEvent(str2, bundle2);
        }
    }
    ...
    public static class PlaybackInfo {
        ...
        private static int toLegacyStreamType(AudioAttributes audioAttributes) {
            ...
            int i = 3;
            if ((1 & audioAttributes2.getFlags()) == 1) {
                i = 7;
            } else if ((4 & audioAttributes2.getFlags()) == 4) {
                return 6;
            } else {
                switch (audioAttributes2.getUsage()) {
                    case 1:
                    case 11:
                    case 12:
                    case 14:
    ...
    public static Object fromToken(Context context, Object obj) {
        ...
        MediaController mediaController3 = new MediaController(context, (Token) obj);
