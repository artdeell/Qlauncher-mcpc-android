...
public class MotionEventCompat {
    ...
    static class BaseMotionEventVersionImpl implements MotionEventVersionImpl {
        ...
        public int getPointerId(MotionEvent motionEvent, int i) {
            ...
            IndexOutOfBoundsException indexOutOfBoundsException3 = new IndexOutOfBoundsException("Pre-Eclair does not support multiple pointers");
    ...
    static {
        BaseMotionEventVersionImpl baseMotionEventVersionImpl;
        EclairMotionEventVersionImpl eclairMotionEventVersionImpl;
        GingerbreadMotionEventVersionImpl gingerbreadMotionEventVersionImpl;
        HoneycombMr1MotionEventVersionImpl honeycombMr1MotionEventVersionImpl;
        if (VERSION.SDK_INT >= 12) {
            HoneycombMr1MotionEventVersionImpl honeycombMr1MotionEventVersionImpl2 = honeycombMr1MotionEventVersionImpl;
            HoneycombMr1MotionEventVersionImpl honeycombMr1MotionEventVersionImpl3 = new HoneycombMr1MotionEventVersionImpl();
            IMPL = honeycombMr1MotionEventVersionImpl2;
        } else if (VERSION.SDK_INT >= 9) {
            GingerbreadMotionEventVersionImpl gingerbreadMotionEventVersionImpl2 = gingerbreadMotionEventVersionImpl;
            GingerbreadMotionEventVersionImpl gingerbreadMotionEventVersionImpl3 = new GingerbreadMotionEventVersionImpl();
            IMPL = gingerbreadMotionEventVersionImpl2;
        } else if (VERSION.SDK_INT >= 5) {
            EclairMotionEventVersionImpl eclairMotionEventVersionImpl2 = eclairMotionEventVersionImpl;
            EclairMotionEventVersionImpl eclairMotionEventVersionImpl3 = new EclairMotionEventVersionImpl();
            IMPL = eclairMotionEventVersionImpl2;
        } else {
            BaseMotionEventVersionImpl baseMotionEventVersionImpl2 = baseMotionEventVersionImpl;
            BaseMotionEventVersionImpl baseMotionEventVersionImpl3 = new BaseMotionEventVersionImpl();
            IMPL = baseMotionEventVersionImpl2;
        }
    }
