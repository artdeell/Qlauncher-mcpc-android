...
public class GravityCompat {
    ...
    static {
        GravityCompatImplBase gravityCompatImplBase;
        GravityCompatImplJellybeanMr1 gravityCompatImplJellybeanMr1;
        if (VERSION.SDK_INT >= 17) {
            GravityCompatImplJellybeanMr1 gravityCompatImplJellybeanMr12 = gravityCompatImplJellybeanMr1;
            GravityCompatImplJellybeanMr1 gravityCompatImplJellybeanMr13 = new GravityCompatImplJellybeanMr1();
            IMPL = gravityCompatImplJellybeanMr12;
            return;
        }
        GravityCompatImplBase gravityCompatImplBase2 = gravityCompatImplBase;
        GravityCompatImplBase gravityCompatImplBase3 = new GravityCompatImplBase();
        IMPL = gravityCompatImplBase2;
    }
