...
public class ParcelableCompat {
    ...
    public static <T> Creator<T> newCreator(ParcelableCompatCreatorCallbacks<T> parcelableCompatCreatorCallbacks) {
        CompatCreator compatCreator;
        ParcelableCompatCreatorCallbacks<T> parcelableCompatCreatorCallbacks2 = parcelableCompatCreatorCallbacks;
        if (VERSION.SDK_INT >= 13) {
            return ParcelableCompatCreatorHoneycombMR2Stub.instantiate(parcelableCompatCreatorCallbacks2);
        }
        CompatCreator compatCreator2 = compatCreator;
        CompatCreator compatCreator3 = new CompatCreator(parcelableCompatCreatorCallbacks2);
        return compatCreator2;
    }
}
