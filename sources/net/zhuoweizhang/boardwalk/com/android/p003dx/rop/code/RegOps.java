...
/* renamed from: net.zhuoweizhang.boardwalk.com.android.dx.rop.code.RegOps */
public final class RegOps {
    ...
    /* renamed from: OR */
    public static final int f183OR = 21;
    ...
    public static int flippedIfOpcode(int i) {
        ...
        switch (i2) {
            ...
            default:
                ...
                RuntimeException runtimeException3 = new RuntimeException(sb2.append("Unrecognized IF regop: ").append(i2).toString());
    ...
    public static String opName(int i) {
        ...
        switch (i2) {
            ...
            default:
                StringBuilder sb2 = sb;
                StringBuilder sb3 = new StringBuilder();
                return sb2.append("unknown-").append(Hex.m50u1(i2)).toString();
        }
    }
}
