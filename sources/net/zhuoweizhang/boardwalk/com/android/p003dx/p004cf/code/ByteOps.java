...
/* renamed from: net.zhuoweizhang.boardwalk.com.android.dx.cf.code.ByteOps */
public class ByteOps {
    ...
    static {
        ...
        while (true) {
            ...
            if (i4 < length) {
                ...
                switch (OPCODE_DETAILS.charAt(i4 + 3)) {
                    case '-':
                        i = 1;
                        break;
                    case '0':
                ...
                if (OPCODE_DETAILS.charAt(i5 - 1) == ':') {
                    while (true) {
                        switch (OPCODE_DETAILS.charAt(i5)) {
                            case 'D':
                                i2 = i | 256;
                                break;
                            case 'F':
    ...
    public static String opName(int i) {
        StringBuilder sb;
        int i2 = i;
        String str = OPCODE_NAMES[i2];
        if (str == null) {
            StringBuilder sb2 = sb;
            StringBuilder sb3 = new StringBuilder();
            str = sb2.append("unused_").append(Hex.m50u1(i2)).toString();
            OPCODE_NAMES[i2] = str;
        }
        return str;
    }
